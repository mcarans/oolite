...
OOINLINE Quaternion quaternion_negate(Quaternion q) { return make_quaternion(-q.w, -q.x, -q.y, -q.z); }

OOINLINE Quaternion quaternion_conjugate(Quaternion q) { return make_quaternion(q.w, -q.x, -q.y, -q.z); }
