...
- (void)update:(OOTimeDelta)delta_t {
    ...
    foreach (e, collidingEntities) {
        // we're going to force the weapon id to be the qbomb key here, because at this point the cascade entity isn't a
        // ship any more and there's no link back to the original.
