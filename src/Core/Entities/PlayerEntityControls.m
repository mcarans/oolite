...
- (void)initControls {
    ...
    keyCodeLookups =
        [[NSDictionary alloc] initWithObjectsAndKeys:[NSNumber numberWithUnsignedShort:gvArrowKeyLeft],
                                                     @ "arrowleft",
                                                     [NSNumber numberWithUnsignedShort:gvArrowKeyLeft],
                                                     @ "leftarrow",
                                                     [NSNumber numberWithUnsignedShort:gvArrowKeyLeft],
                                                     @ "left",
                                                     [NSNumber numberWithUnsignedShort:gvArrowKeyRight],
                                                     @ "arrowright",
                                                     [NSNumber numberWithUnsignedShort:gvArrowKeyRight],
                                                     @ "rightarrow",
                                                     [NSNumber numberWithUnsignedShort:gvArrowKeyRight],
                                                     @ "right",
                                                     [NSNumber numberWithUnsignedShort:gvArrowKeyUp],
                                                     @ "arrowup",
                                                     [NSNumber numberWithUnsignedShort:gvArrowKeyUp],
                                                     @ "uparrow",
                                                     [NSNumber numberWithUnsignedShort:gvArrowKeyUp],
                                                     @ "up",
                                                     [NSNumber numberWithUnsignedShort:gvArrowKeyDown],
                                                     @ "arrowdown",
                                                     [NSNumber numberWithUnsignedShort:gvArrowKeyDown],
                                                     @ "downarrow",
                                                     [NSNumber numberWithUnsignedShort:gvArrowKeyDown],
                                                     @ "down",
                                                     [NSNumber numberWithUnsignedShort:gvPageUpKey],
                                                     @ "pageup",
                                                     [NSNumber numberWithUnsignedShort:gvPageDownKey],
                                                     @ "pagedown",
                                                     [NSNumber numberWithUnsignedShort:13],
                                                     @ "enter",
                                                     [NSNumber numberWithUnsignedShort:13],
                                                     @ "return",
                                                     [NSNumber numberWithUnsignedShort:27],
                                                     @ "escape",
                                                     [NSNumber numberWithUnsignedShort:27],
                                                     @ "esc",
                                                     [NSNumber numberWithUnsignedShort:9],
                                                     @ "tab",
                                                     [NSNumber numberWithUnsignedShort:32],
                                                     @ "space",
                                                     [NSNumber numberWithUnsignedShort:32],
                                                     @ "spc",
                                                     [NSNumber numberWithUnsignedShort:gvHomeKey],
                                                     @ "home",
                                                     [NSNumber numberWithUnsignedShort:gvEndKey],
                                                     @ "end",
                                                     [NSNumber numberWithUnsignedShort:gvDeleteKey],
                                                     @ "delete",
                                                     [NSNumber numberWithUnsignedShort:gvDeleteKey],
                                                     @ "del",
                                                     [NSNumber numberWithUnsignedShort:gvBackspaceKey],
                                                     @ "backspace",
                                                     [NSNumber numberWithUnsignedShort:gvBackspaceKey],
                                                     @ "backspc",
                                                     [NSNumber numberWithUnsignedShort:gvBackspaceKey],
                                                     ...
                                                     [NSNumber numberWithUnsignedShort:gvBackspaceKey],
                                                     @ "bkspc",
                                                     [NSNumber numberWithUnsignedShort:gvInsertKey],
                                                     @ "insert",
                                                     [NSNumber numberWithUnsignedShort:gvInsertKey],
                                                     @ "ins",
                                                     [NSNumber numberWithUnsignedShort:gvFunctionKey1],
                                                     @ "f1",
                                                     [NSNumber numberWithUnsignedShort:gvFunctionKey2],
                                                     @ "f2",
                                                     [NSNumber numberWithUnsignedShort:gvFunctionKey3],
                                                     @ "f3",
                                                     [NSNumber numberWithUnsignedShort:gvFunctionKey4],
                                                     @ "f4",
                                                     [NSNumber numberWithUnsignedShort:gvFunctionKey5],
                                                     @ "f5",
                                                     [NSNumber numberWithUnsignedShort:gvFunctionKey6],
                                                     @ "f6",
                                                     [NSNumber numberWithUnsignedShort:gvFunctionKey7],
                                                     @ "f7",
                                                     [NSNumber numberWithUnsignedShort:gvFunctionKey8],
                                                     @ "f8",
                                                     [NSNumber numberWithUnsignedShort:gvFunctionKey9],
                                                     @ "f9",
                                                     [NSNumber numberWithUnsignedShort:gvFunctionKey10],
                                                     @ "f10",
                                                     [NSNumber numberWithUnsignedShort:gvFunctionKey11],
                                                     @ "f11",
                                                     [NSNumber numberWithUnsignedShort:gvPauseKey],
                                                     @ "pause",
                                                     [NSNumber numberWithUnsignedShort:gvPrintScreenKey],
                                                     @ "printscreen",
                                                     [NSNumber numberWithUnsignedShort:gvPrintScreenKey],
                                                     @ "prtscrn",
                                                     [NSNumber numberWithUnsignedShort:gvPrintScreenKey],
                                                     ...
                                                     [NSNumber numberWithUnsignedShort:gvPrintScreenKey],
                                                     @ "prtscn",
                                                     [NSNumber numberWithUnsignedShort:gvNumberPadKey0],
                                                     @ "numpad0",
                                                     [NSNumber numberWithUnsignedShort:gvNumberPadKey1],
                                                     @ "numpad1",
                                                     [NSNumber numberWithUnsignedShort:gvNumberPadKey2],
                                                     @ "numpad2",
                                                     [NSNumber numberWithUnsignedShort:gvNumberPadKey3],
                                                     @ "numpad3",
                                                     [NSNumber numberWithUnsignedShort:gvNumberPadKey4],
                                                     @ "numpad4",
                                                     [NSNumber numberWithUnsignedShort:gvNumberPadKey5],
                                                     @ "numpad5",
                                                     [NSNumber numberWithUnsignedShort:gvNumberPadKey6],
                                                     @ "numpad6",
                                                     [NSNumber numberWithUnsignedShort:gvNumberPadKey7],
                                                     @ "numpad7",
                                                     [NSNumber numberWithUnsignedShort:gvNumberPadKey8],
                                                     @ "numpad8",
                                                     [NSNumber numberWithUnsignedShort:gvNumberPadKey9],
                                                     @ "numpad9",
                                                     [NSNumber numberWithUnsignedShort:gvNumberPadKeyDivide],
                                                     @ "numpad/",
                                                     [NSNumber numberWithUnsignedShort:gvNumberPadKeyDivide],
                                                     @ "numpaddivide",
                                                     [NSNumber numberWithUnsignedShort:gvNumberPadKeyMultiply],
                                                     @ "numpad*",
                                                     [NSNumber numberWithUnsignedShort:gvNumberPadKeyMultiply],
                                                     @ "numpadmultiply",
                                                     [NSNumber numberWithUnsignedShort:gvNumberPadKeyMinus],
                                                     @ "numpad-",
                                                     [NSNumber numberWithUnsignedShort:gvNumberPadKeyMinus],
                                                     @ "numpadminus",
                                                     [NSNumber numberWithUnsignedShort:gvNumberPadKeyPlus],
                                                     @ "numpad+",
                                                     [NSNumber numberWithUnsignedShort:gvNumberPadKeyPlus],
                                                     @ "numpadplus",
                                                     [NSNumber numberWithUnsignedShort:gvNumberPadKeyPeriod],
                                                     @ "numpad.",
                                                     [NSNumber numberWithUnsignedShort:gvNumberPadKeyPeriod],
                                                     @ "numpadperiod",
                                                     [NSNumber numberWithUnsignedShort:gvNumberPadKeyEquals],
                                                     @ "numpad=",
                                                     [NSNumber numberWithUnsignedShort:gvNumberPadKeyEquals],
                                                     @ "numpadequals",
                                                     [NSNumber numberWithUnsignedShort:gvNumberPadKeyEnter],
                                                     @ "numpadenter",
                                                     nil];
...
- (void)initKeyConfigSettings {
    NSMutableDictionary *kdicmaster =
        [NSMutableDictionary dictionaryWithDictionary:[ResourceManager dictionaryFromFilesNamed:@ "keyconfig2.plist"
                                                                                       inFolder:@ "Config"
...
#define LOAD_KEY_SETTING2(name, default_1, shift_1, mod1_1, default_2, shift_2, mod1_2)                   \
    ...
    key1 = [[NSDictionary alloc] initWithObjectsAndKeys:[NSNumber numberWithUnsignedShort:default_1],     \
                                                        @ "key",                                           \
                                                        [NSNumber numberWithBool:shift_1],                \
                                                        @ "shift",                                         \
                                                        [NSNumber numberWithBool:mod1_1],                 \
                                                        @ "mod1",                                          \
    ...
    if (default_2 > 0) {                                                                                  \
        key2 = [[NSDictionary alloc] initWithObjectsAndKeys:[NSNumber numberWithUnsignedShort:default_2], \
                                                            @ "key",                                       \
                                                            [NSNumber numberWithBool:shift_2],            \
                                                            @ "shift",                                     \
                                                            [NSNumber numberWithBool:mod1_2],             \
                                                            @ "mod1",                                      \
                                                            [NSNumber numberWithBool:NO],                 \
                                                            @ "mod2",                                      \
                                                            nil];                                         \
...
- (NSArray *)processKeyCode:(NSArray *)key_def {
    ...
    for (i = 0; i < [key_def count]; i++) {
        ...
        if ([def objectForKey:@ "shift"])
            [defNew setObject:[def objectForKey:@ "shift"] forKey:@ "shift"];
        else
            [defNew setObject:[NSNumber numberWithBool:NO] forKey:@ "shift"];
        if ([def objectForKey:@ "mod1"])
            [defNew setObject:[def objectForKey:@ "mod1"] forKey:@ "mod1"];
        else
            [defNew setObject:[NSNumber numberWithBool:NO] forKey:@ "mod1"];
        if ([def objectForKey:@ "mod2"])
            [defNew setObject:[def objectForKey:@ "mod2"] forKey:@ "mod2"];
        else
            [defNew setObject:[NSNumber numberWithBool:NO] forKey:@ "mod2"];
...
- (BOOL)checkKeyPress:(NSArray *)key_def fKey_only:(BOOL)fKey_only ignore_ctrl:(BOOL)ignore_ctrl {
    ...
    for (i = 0; i < [key_def count]; i++) {
        ...
        // switch screens directly (they would need to finish the task - ie press enter, or use the escape key to cancel
        // the function) note: the logic below now means that the state of the modifiers must match the requirements for
        // the key binding, including when all settings are off. This means, if the player presses two functions at
        // once, one that requires a modifier and one that doesn't, the one that doesn't will not be triggered.
        if (fKey_only == YES && (keycode < gvFunctionKey1 || keycode > gvFunctionKey11)) continue;
        if ([gameView isDown:keycode] && ([[def objectForKey:@ "shift"] boolValue] == [gameView isShiftDown]) &&
...
- (BOOL)handleGUIUpDownArrowKeys {
    ...
    if (arrow_down) {
        if ((!upDownKeyPressed) || (script_time > timeLastKeyPress + KEY_REPEAT_INTERVAL)) {
            ...
            if (result && [gui selectableRange].length > 1)
    ...
    if (mouse_click) {
        if (!upDownKeyPressed) {
            int click_row = 0;
            if (UNIVERSE) click_row = UNIVERSE->cursor_row;
...
- (void)noteSwitchToView:(OOViewID)toView fromView:(OOViewID)fromView {
    [self switchToThisView:toView
                      fromView:fromView
        andProcessWeaponFacing:NO
                    justNotify:YES];  // no extra processing needed!
}
...
- (void)beginWitchspaceCountdown:(int)spin_time {
    if ([self hasHyperspaceMotor]) {
        ...
        [self
            doScriptEvent:OOJSID("playerStartedJumpCountdown")
...
- (void)pollApplicationControls {
    ...
    BOOL onTextEntryScreen = (gui_screen == GUI_SCREEN_LONG_RANGE_CHART) || (gui_screen == GUI_SCREEN_MISSION) ||
                             ...
                             (gui_screen == GUI_SCREEN_OXZMANAGER || (gui_screen == GUI_SCREEN_KEYBOARD_ENTRY));
...
//  command-key controls
        ...
        if (([self checkKeyPress:n_key_snapshot] || joyButtonState[BUTTON_SNAPSHOT]) &&
            ([gameView allowingStringInput] <=
             gvStringInputAlpha) &&  // not while entering text on the keyboard config screens
            ![[OOOXZManager sharedManager]
                isAcceptingTextInput])  //  '*' key but not while filtering inside OXZ Manager
        {
        ...
        if (allowMouseControl) {
            ...
            if (!onTextEntryScreen && ([self checkKeyPress:n_key_mouse_control_roll] ||
                                       [self checkKeyPress:n_key_mouse_control_yaw]))  //  'M' key
            {
                if (!m_key_pressed) {
                    ...
                    if (mouse_control_on) {
                        ...
                        keyboardRollOverride = mouse_x_axis_map_to_yaw;  // Getafix: set keyboardRollOverride to TRUE
                                                                         // only if yaw is mapped to mouse x-axis
        ...
        // HUD toggle
        if (([self checkKeyPress:n_key_hud_toggle] || joyButtonState[BUTTON_TOGGLEHUD]) &&
            [gameController isGamePaused] && !onTextEntryScreen)  // 'o' key while paused
        {
        ...
        OOLog(kOOLogException,
              @ "***** Exception in pollApplicationControls [%@]: %@ : %@",
              exceptionContext,
              [exception name],
              [exception reason]);
    }
    ...
    @try {
        ...
        if (!paused && gui_screen == GUI_SCREEN_MISSION) {
            ...
            if ([stickHandler joystickCount]) {
                ...
                if (virtualView.y == STICK_AXISUNASSIGNED) virtualView.y = 0.0;
                if (virtualView.x == STICK_AXISUNASSIGNED) virtualView.x = 0.0;
            ...
            if ([self checkKeyPress:n_key_view_forward] || (virtualView.y < -view_threshold) ||
                joyButtonState[BUTTON_VIEWFORWARD]) {
                view = VIEW_FORWARD;
            }
            if ([self checkKeyPress:n_key_view_aft] | (virtualView.y > view_threshold) ||
                joyButtonState[BUTTON_VIEWAFT]) {
                view = VIEW_AFT;
            }
            if ([self checkKeyPress:n_key_view_port] || (virtualView.x < -view_threshold) ||
                joyButtonState[BUTTON_VIEWPORT]) {
                view = VIEW_PORT;
            }
            if ([self checkKeyPress:n_key_view_starboard] || (virtualView.x > view_threshold) ||
                joyButtonState[BUTTON_VIEWSTARBOARD]) {
                view = VIEW_STARBOARD;
            }
            if (view == VIEW_NONE) {
            ...
            if (OOMouseInteractionModeIsFlightMode([[UNIVERSE gameController] mouseInteractionMode])) {
                ...
                if ((joyButtonState[BUTTON_FUELINJECT] || [self checkKeyPress:n_key_inject_fuel]) &&
                    [self hasFuelInjection] && !hyperspeed_engaged) {
                    if (fuel > 0 && !afterburner_engaged) {
                        ...
                        if (fuel <= 0.0) [UNIVERSE addMessage:DESC(@ "fuel-out") forCount:1.5];
                    }
                    afterburner_engaged = (fuel > 0);
                } else
                    afterburner_engaged = NO;

                if ((!afterburner_engaged) && (afterburnerSoundLooping)) [self stopAfterburnerSound];
                ...
                if (([self checkKeyPress:n_key_increase_speed] || joyButtonState[BUTTON_INCTHRUST] ||
                     ((mouse_control_on) && ([gameView mouseWheelState] == gvMouseWheelUp) &&
                ...
                if (([self checkKeyPress:n_key_decrease_speed] || joyButtonState[BUTTON_DECTHRUST] ||
                     ((mouse_control_on) && ([gameView mouseWheelState] == gvMouseWheelDown) &&
                      ([UNIVERSE viewDirection] <= VIEW_STARBOARD || ![gameView isCapsLockOn]))) &&
                    (!afterburner_engaged)) {
                    flightSpeed -= speed_delta * delta_t * mouseWheelDeltaFactor;
                ...
                NSDictionary *functionForThrustAxis = [[stickHandler axisFunctions]
                    oo_dictionaryForKey:[[NSNumber numberWithInt:AXIS_THRUST] stringValue]];
                ...
                //  shoot 'a'
                if ((([self checkNavKeyPress:n_key_fire_lasers]) ||
                     ((mouse_control_on) && ([gameView isDown:gvMouseLeftButton]) &&
                      ([UNIVERSE viewDirection] <= VIEW_STARBOARD || ![gameView isCapsLockOn])) ||
                     joyButtonState[BUTTON_FIRE]) &&
                    (shot_time > weapon_recharge_rate)) {
                    if ([self fireMainWeapon]) {
                        [self playLaserHit:([self shipHitByLaser] != nil)
                                      offset:[[self currentLaserOffset] oo_vectorAtIndex:0]
                            weaponIdentifier:[[self currentWeapon] identifier]];
                    }
                }
                ...
                if (([self checkKeyPress:n_key_weapons_online_toggle] || joyButtonState[BUTTON_WEAPONSONLINETOGGLE])) {
                    if (!weaponsOnlineToggle_pressed) {
                        ...
                        weaponsOnlineToggleMsg =
                            [self weaponsOnline] ? DESC(@ "weapons-systems-online") : DESC(@ "weapons-systems-offline");
                        ...
                        [self doScriptEvent:OOJSID("weaponsSystemsToggled")
                               withArgument:[NSNumber numberWithBool:[self weaponsOnline]]];
                        weaponsOnlineToggle_pressed = YES;
                    }
                } else
                    weaponsOnlineToggle_pressed = NO;
                ...
                if ([self checkKeyPress:n_key_prime_next_equipment] ||
                    [self checkKeyPress:n_key_prime_previous_equipment] || joyButtonState[BUTTON_PRIMEEQUIPMENT] ||
                    joyButtonState[BUTTON_PRIMEEQUIPMENT_PREV]) {
                    if (!prime_equipment_pressed) {
                        ...
                        if (primedEquipment == c) {
                            if (c > 0) {
                                ...
                                [UNIVERSE addMessage:DESC(@ "equipment-primed-none-available") forCount:2.0];
                        } else {
                            [self playNextEquipmentSelected];
                            NSString *equipmentName = [[OOEquipmentType
                                equipmentTypeWithIdentifier:[[eqScripts oo_arrayAtIndex:primedEquipment]
                                                                oo_stringAtIndex:0]] name];
                ...
                if ([self checkKeyPress:n_key_fastactivate_equipment_a] || joyButtonState[BUTTON_CLOAK]) {
                    if (!fastactivate_a_pressed) {
                        [self activatePrimableEquipment:[self eqScriptIndexForKey:[self fastEquipmentA]]
                                               withMode:OOPRIMEDEQUIP_ACTIVATED];
                    }
                    fastactivate_a_pressed = YES;
                } else
                    fastactivate_a_pressed = NO;
                ...
                if ([self checkKeyPress:n_key_fastactivate_equipment_b] || joyButtonState[BUTTON_ENERGYBOMB]) {
                    if (!fastactivate_b_pressed) {
                        [self activatePrimableEquipment:[self eqScriptIndexForKey:[self fastEquipmentB]]
                                               withMode:OOPRIMEDEQUIP_ACTIVATED];
                    }
                    fastactivate_b_pressed = YES;
                } else
                    fastactivate_b_pressed = NO;
                ...
                for (i = 0; i < [customEquipActivation count]; i++) {
                    ...
                    if ([self hasOneEquipmentItem:[item oo_stringForKey:CUSTOMEQUIP_EQUIPKEY]
                                   includeWeapons:NO
                                     whileLoading:NO]) {
                        ...
                        if ((key_act && [self checkKeyPress:key_act]) ||
                            (but_act && [[OOJoystickManager sharedStickHandler]
                                            isButtonDown:[but_act oo_intForKey:STICK_AXBUT]
                                                   stick:[but_act oo_intForKey:STICK_NUMBER]])) {
                            if (![[customActivatePressed objectAtIndex:i] boolValue]) {
                                // initate the activate JS code
                                [self activatePrimableEquipment:
                                          [self eqScriptIndexForKey:[item oo_stringForKey:CUSTOMEQUIP_EQUIPKEY]]
                                                       withMode:OOPRIMEDEQUIP_ACTIVATED];
                            }
                            [customActivatePressed replaceObjectAtIndex:i withObject:[NSNumber numberWithBool:YES]];
                        } else
                            [customActivatePressed replaceObjectAtIndex:i withObject:[NSNumber numberWithBool:NO]];

                        // check to see if the key or button was pressed for mode
                        if ((key_mod && [self checkKeyPress:key_mod]) ||
                            (but_mod && [[OOJoystickManager sharedStickHandler]
                                            isButtonDown:[but_mod oo_intForKey:STICK_AXBUT]
                                                   stick:[but_mod oo_intForKey:STICK_NUMBER]])) {
                            if (![[customModePressed objectAtIndex:i] boolValue]) {
                                // initiate the activate JS code
                                [self activatePrimableEquipment:
                                          [self eqScriptIndexForKey:[item oo_stringForKey:CUSTOMEQUIP_EQUIPKEY]]
                                                       withMode:OOPRIMEDEQUIP_MODE];
                            }
                            [customModePressed replaceObjectAtIndex:i withObject:[NSNumber numberWithBool:YES]];
                        } else
                            [customModePressed replaceObjectAtIndex:i withObject:[NSNumber numberWithBool:NO]];
                    }
                }
                ...
                if ([self checkKeyPress:n_key_target_incoming_missile] ||
                    joyButtonState[BUTTON_TARGETINCOMINGMISSILE]) {
                    if (!target_incoming_missile_pressed) {
                        [self targetNearestIncomingMissile];
                    }
                    target_incoming_missile_pressed = YES;
                } else
                    target_incoming_missile_pressed = NO;

                exceptionContext = @ "missile T";
                //  shoot 't'   // switch on missile targeting
                if (([self checkKeyPress:n_key_target_missile] || joyButtonState[BUTTON_ARMMISSILE]) &&
                    (missile_entity[activeMissile])) {
                    // targeting 'on' here
                ...
                //  shoot 'escape'   // Escape pod launch - NOTE: Allowed at all times, but requires double press within
                //  a specific time interval.
                // Double press not available in strict mode or when the "escape-pod-activation-immediate" override is
                // in the user defaults file.
                if (([self checkKeyPress:n_key_launch_escapepod] || joyButtonState[BUTTON_ESCAPE]) &&
                    [self hasEscapePod]) {
                    BOOL goodToLaunch =
                ...
                if ([self checkKeyPress:n_key_rotate_cargo] || joyButtonState[BUTTON_ROTATECARGO]) {
                    if ((!rotateCargo_pressed) && ([cargo count] > 0)) [self rotateCargo];
                    ...
                    ([self hasEquipmentItemProviding:@ "EQ_GAL_DRIVE"]))  // look for the 'g' key
                {
                    if (!galhyperspace_pressed) {
                        if ([self status] == STATUS_WITCHSPACE_COUNTDOWN) {
                            ...
                            if (EXPECT([self hasHyperspaceMotor]))
                                witchspaceCountdown = hyperspaceMotorSpinTime;
                            else
                                witchspaceCountdown = DEFAULT_HYPERSPACE_SPIN_TIME;

                            [self setStatus:STATUS_WITCHSPACE_COUNTDOWN];
                            [self playGalacticHyperspace];
                            // say it!
                            [UNIVERSE addMessage:[NSString stringWithFormat:DESC(@ "witch-galactic-in-f-seconds"),
                                                                            witchspaceCountdown]
                                        forCount:1.0];
                            ...
                            [self
                                doScriptEvent:OOJSID("playerStartedJumpCountdown")
                                withArguments:[NSArray arrayWithObjects:@ "galactic",
                                                                        [NSNumber numberWithFloat:witchspaceCountdown],
                                                                        nil]];
                        }
                    }
            ...
            if (![UNIVERSE displayGUI]) {
                if (([self checkKeyPress:n_key_inc_field_of_view] || joyButtonState[BUTTON_INC_FIELD_OF_VIEW]) &&
                    (fieldOfView < MAX_FOV)) {
                    fieldOfView *= pow(fov_delta, delta_t);
                    if (fieldOfView > MAX_FOV) fieldOfView = MAX_FOV;
                }

                if (([self checkKeyPress:n_key_dec_field_of_view] || joyButtonState[BUTTON_DEC_FIELD_OF_VIEW]) &&
                    (fieldOfView > MIN_FOV)) {
                    fieldOfView /= pow(fov_delta, delta_t);
                    if (fieldOfView < MIN_FOV) fieldOfView = MIN_FOV;
                }

                NSDictionary *functionForFovAxis = [[stickHandler axisFunctions]
                    oo_dictionaryForKey:[[NSNumber numberWithInt:AXIS_FIELD_OF_VIEW] stringValue]];
            ...
            if ([self checkKeyPress:n_key_debug_console_connect] &&
                ![[OODebugMonitor sharedDebugMonitor] usingPlugInController] &&
                ![gameView allowingStringInput])  // look for the 'c' key
            {
            ...
            if ([self checkKeyPress:n_key_debug_bounding_boxes] &&
                ![gameView allowingStringInput])  // look for the 'x' key
            {
            ...
            if (([self checkKeyPress:n_key_gui_arrow_left] || [self checkKeyPress:n_key_gui_arrow_right]) &&
                gui_screen != GUI_SCREEN_GAMEOPTIONS && [UNIVERSE displayFPS] && ![gameView allowingStringInput]) {
                if (!leftRightKeyPressed) {
                    float newTimeAccelerationFactor =
        ...
        if (([self checkKeyPress:n_key_pausebutton] || joyButtonState[BUTTON_PAUSE]) &&
            gui_screen != GUI_SCREEN_LONG_RANGE_CHART && gui_screen != GUI_SCREEN_MISSION &&
            ![gameView allowingStringInput])  // look for the 'p' key
        {
            if (!pause_pressed) {
                if (paused) {
                    script_time = saved_script_time;
                    ...
                    switch (saved_gui_screen) {
                        ...
                        case GUI_SCREEN_SYSTEM_DATA:
                            ...
                            if (gui_screen != GUI_SCREEN_SYSTEM_DATA) [self setGuiToSystemDataScreen];
                            break;
                        default:
        ...
        OOLog(kOOLogException,
              @ "***** Exception in pollFlightControls [%@]: %@ : %@",
              exceptionContext,
              [exception name],
              [exception reason]);
    }
...
- (void)pollGuiArrowKeyControls:(double)delta_t {
    ...
    switch (gui_screen) {
        ...
        case GUI_SCREEN_SHORT_RANGE_CHART:
            ...
            if ([self checkKeyPress:n_key_chart_highlight]) {
                if (!queryPressed) {
                    ...
                    [self doScriptEvent:OOJSID("chartHighlightModeChanged")
                           withArgument:OOStringFromLongRangeChartMode([self longRangeChartMode])];
                }
                queryPressed = YES;
            } else {
                queryPressed = NO;
            ...
            if ([self status] != STATUS_WITCHSPACE_COUNTDOWN) {
                if ([self hasEquipmentItemProviding:@ "EQ_ADVANCED_NAVIGATIONAL_ARRAY"]) {
                    if ([self checkKeyPress:n_key_advanced_nav_array_next] ||
                ...
                if ([gameView isDown:gvMouseLeftButton]) {
                    ...
                    if (mouse_left_down == NO) {
                        ...
                        chart_focus_coordinates.x =
                            OOClamp_0_max_f(centre.x + (maus.x * MAIN_GUI_PIXEL_WIDTH) / hscale, 256.0);
                        chart_focus_coordinates.y =
                            OOClamp_0_max_f(centre.y + (maus.y * MAIN_GUI_PIXEL_HEIGHT + vadjust) / vscale, 256.0);
                    ...
                    if (fabs(maus.x - mouse_click_position.x) * MAIN_GUI_PIXEL_WIDTH > 2 ||
                        ...
                        chart_centre_coordinates.x = OOClamp_0_max_f(
                            centre_at_mouse_click.x - (maus.x - mouse_click_position.x) * MAIN_GUI_PIXEL_WIDTH / hscale,
                            256.0);
                        chart_centre_coordinates.y =
                            OOClamp_0_max_f(centre_at_mouse_click.y -
                                                (maus.y - mouse_click_position.y) * MAIN_GUI_PIXEL_HEIGHT / vscale,
                                            256.0);
                        target_chart_centre = chart_centre_coordinates;
                        dragging = YES;
                    }
                    if (gui_screen == GUI_SCREEN_LONG_RANGE_CHART) [gameView resetTypedString];
                    mouse_left_down = YES;
                ...
                if ((cursor_moving) && (!moving)) {
                    if (found_system_id == -1) {
                        ...
                        // if found with a search string, don't recalculate! Required for overlapping systems, like
                        // Divees & Tezabi in galaxy 5
                        NSPoint fpos = [[UNIVERSE systemManager] getCoordinatesForSystem:found_system_id
                                                                                inGalaxy:galaxy_number];
                    ...
                    cursor_coordinates = [[UNIVERSE systemManager] getCoordinatesForSystem:target_system_id
                                                                                  inGalaxy:galaxy_number];
                }
        ...
        case GUI_SCREEN_SHIPLIBRARY:
            ...
            {
                if (!upDownKeyPressed) [UNIVERSE selectIntro2Previous];
            }
            if ([self checkKeyPress:n_key_gui_arrow_down])  //  '-->'
            {
                if (!upDownKeyPressed) [UNIVERSE selectIntro2Next];
            }
            upDownKeyPressed =
                (([self checkKeyPress:n_key_gui_arrow_up]) || ([self checkKeyPress:n_key_gui_arrow_down]));

            if ([self checkKeyPress:n_key_gui_arrow_left])  //  '<--'
            {
                if (!leftRightKeyPressed) [UNIVERSE selectIntro2PreviousCategory];
            }
            if ([self checkKeyPress:n_key_gui_arrow_right])  //  '-->'
            {
                if (!leftRightKeyPressed) [UNIVERSE selectIntro2NextCategory];
            }
            leftRightKeyPressed =
                (([self checkKeyPress:n_key_gui_arrow_left]) || ([self checkKeyPress:n_key_gui_arrow_right]));
        ...
        case GUI_SCREEN_OPTIONS:
            ...
            if (selectKeyPress)  // 'enter'
            {
                ...
                if ((guiSelectedRow == GUI_ROW(, BEGIN_NEW)) && (!disc_operation_in_progress)) {
                    disc_operation_in_progress = YES;
                    [UNIVERSE setUseAddOns:SCENARIO_OXP_DEFINITION_ALL
                              fromSaveGame:NO
                               forceReinit:YES];  // calls reinitAndShowDemo
                }
        ...
        case GUI_SCREEN_EQUIP_SHIP:
            if ([self handleGUIUpDownArrowKeys]) {
                ...
                if (weaponType != nil) {
                    ...
                    if ([[weaponType identifier] isEqualToString:@ "EQ_WEAPON_NONE"])
                        itemText = DESC(@ "no-weapon-enter-to-install");
                    else {
                        NSString *weaponName = [[OOEquipmentType
                            equipmentTypeWithIdentifier:OOEquipmentIdentifierFromWeaponType(weaponType)] name];
                        if (sameAs)
                            itemText = [NSString stringWithFormat:DESC(@ "weapon-installed-@"), weaponName];
                        else
                            itemText = [NSString stringWithFormat:DESC(@ "weapon-@-enter-to-replace"), weaponName];
                    }
            ...
            leftRightKeyPressed = [self checkKeyPress:n_key_gui_arrow_right] |
                                  [self checkKeyPress:n_key_gui_arrow_left] | [self checkKeyPress:n_key_gui_page_down] |
        ...
        case GUI_SCREEN_REPORT:
            if ([gameView isDown:32])  // spacebar
            {
                if (!spacePressed) {
                    ...
                    if (reportEnded) {
                        [self setGuiToStatusScreen];
                        [self doScriptEvent:OOJSID("reportScreenEnded")];  // last report given. Screen is now free for
                                                                           // missionscreens.
        ...
        case GUI_SCREEN_STATUS:
            ...
            if ([self checkKeyPress:n_key_gui_arrow_right] || [self checkKeyPress:n_key_gui_page_down]) {
                if ((!leftRightKeyPressed) || (script_time > timeLastKeyPress + KEY_REPEAT_INTERVAL)) {
                    NSUInteger maxRows = [[self hud] allowBigGui]
                                             ? STATUS_EQUIPMENT_MAX_ROWS + STATUS_EQUIPMENT_BIGGUI_EXTRA_ROWS
        ...
        case GUI_SCREEN_SHIPYARD:
                ...
                if (!selectPressed) {
                    ...
                    if ([self buySelectedShip]) {
                        if (![key hasPrefix:@ "More:"])  // don't do anything if we clicked/selected a "More:" line
                        {
                            ...
                            [self setGuiToStatusScreen];
                            [self playBuyShip];
                            [self doScriptEvent:OOJSID("playerBoughtNewShip")
                                   withArgument:self
                                    andArgument:[NSNumber
                                                    numberWithUnsignedLongLong:shipprice]];  // some equipment.oxp might
            ...
            if ([gameView isDown:gvMouseDoubleClick]) {
                if (([gui selectedRow] == GUI_ROW_SHIPYARD_START + MAX_ROWS_SHIPS_FOR_SALE - 1) &&
                    [[gui keyForRow:GUI_ROW_SHIPYARD_START + MAX_ROWS_SHIPS_FOR_SALE - 1] hasPrefix:@ "More:"]) {
                    [self playMenuPageNext];
                    [gui setSelectedRow:GUI_ROW_SHIPYARD_START + MAX_ROWS_SHIPS_FOR_SALE - 1];
                    [self buySelectedShip];
                } else if (([gui selectedRow] == GUI_ROW_SHIPYARD_START) &&
                           [[gui keyForRow:GUI_ROW_SHIPYARD_START] hasPrefix:@ "More:"]) {
                    [self playMenuPagePrevious];
                    [gui setSelectedRow:GUI_ROW_SHIPYARD_START];
                    [self buySelectedShip];
                }
                ...
                if ([self checkKeyPress:[keydefs objectForKey:key]]) {
                    if (!extra_gui_key_pressed) {
                        ...
                        if (definition) {
                            ...
                            OOLog(@ "interface.missingCallback",
                                  @ "Unable to find callback definition for %@ using key %@",
                                  [definition name],
                                  key);
                        }
                    }
...
- (void)pollMarketScreenControls {
    ...
    if (gui_screen == GUI_SCREEN_MARKET) {
        ...
        if (page_up || page_down) {
            if ((!pageUpDownKeyPressed) || (script_time > timeLastKeyPress + KEY_REPEAT_INTERVAL)) {
                ...
                NSArray *goods = [self applyMarketSorter:[self applyMarketFilter:[localMarket goods]
                ...
                if ([goods count] > 0) {
                    ...
                    if (page_up) {
                        ...
                        if (offset1 == 1 && offset2 == 0 && goodsIndex < (NSInteger)[goods count] - 1 &&
                            goodsIndex - 15 > 0)
                            offset2 = 1;
                    ...
                    if (page_down) {
                        ...
                        goodsIndex += (16 - (offset1 + offset2));
                        if (goodsIndex > ((NSInteger)[goods count] - 1) || [goods count] <= 17)
                            goodsIndex = (NSInteger)[goods count] - 1;
                    }
                    DESTROY(marketSelectedCommodity);
    ...
    if (([self checkNavKeyPress:n_key_gui_arrow_right]) || ([self checkNavKeyPress:n_key_gui_arrow_left]) ||
        ([self checkKeyPress:n_key_gui_select] || [gameView isDown:gvMouseDoubleClick])) {
        if ([self checkNavKeyPress:n_key_gui_arrow_right])  // -->
        {
            if (!wait_for_key_up) {
        ...
        if ((gui_screen == GUI_SCREEN_MARKET && [gameView isDown:gvMouseDoubleClick]) ||
            [self checkKeyPress:n_key_gui_select])  // 'enter'
        {
            if ([gameView isDown:gvMouseDoubleClick]) {
                wait_for_key_up = NO;
                [gameView clearMouse];
            ...
            if (!wait_for_key_up) {
                ...
                if ([item isEqualToString:@ ">>>"]) {
                    ...
                    [self setGuiToMarketScreen];
                } else if (isdocked && [gameView isShiftDown] &&
                           [self tryBuyingCommodity:item all:YES])  // buy as much as possible (with Shift)
                {
                    [self playBuyCommodity];
                    if (gui_screen == GUI_SCREEN_MARKET) {
                        [self setGuiToMarketScreen];
...
- (void)handleGameOptionsScreenKeys {
    ...
    if ([gameView hdrOutput]) {
        if ((guiSelectedRow == GUI_ROW(GAME, HDRMAXBRIGHTNESS)) &&
            ...
            if (!hdrMaxBrightnessControlPressed) {
                ...
                if (brightnessIdx < 0) brightnessIdx = count - 1;
                if (brightnessIdx >= count) brightnessIdx = 0;
                ...
                if (brightnessValue < MIN_HDR_MAXBRIGHTNESS)
                    brightnessValue = direction == -1 ? MAX_HDR_MAXBRIGHTNESS : MIN_HDR_MAXBRIGHTNESS;
                if (brightnessValue > MAX_HDR_MAXBRIGHTNESS)
                    brightnessValue = direction == 1 ? MIN_HDR_MAXBRIGHTNESS : MAX_HDR_MAXBRIGHTNESS;
...
#if OO_RESOLUTION_OPTION
    if (!switching_resolution && guiSelectedRow == GUI_ROW(GAME, DISPLAY) &&
        ([self checkKeyPress:n_key_gui_arrow_right] || [self checkKeyPress:n_key_gui_arrow_left])) {
        GameController *controller = [UNIVERSE gameController];
        int direction = ([self checkKeyPress:n_key_gui_arrow_right]) ? 1 : -1;
        ...
        if (displayModeIndex == (NSInteger)NSNotFound) {
            OOLogWARN(
                @ "graphics.mode.notFound", @ "%@", @ "couldn't find current fullscreen setting, switching to default.");
            displayModeIndex = 0;
        }

        displayModeIndex = displayModeIndex + direction;
        int count = [modes count];
        if (displayModeIndex < 0) displayModeIndex = count - 1;
        if (displayModeIndex >= count) displayModeIndex = 0;
    ...
    if (switching_resolution && ![self checkKeyPress:n_key_gui_arrow_right] &&
    ...
    if ((guiSelectedRow == GUI_ROW(GAME, SPEECH)) &&
        (([self checkKeyPress:n_key_gui_arrow_right]) || ([self checkKeyPress:n_key_gui_arrow_left]))) {
    ...
    if ((guiSelectedRow == GUI_ROW(GAME, MUSIC)) &&
        (([self checkKeyPress:n_key_gui_arrow_right]) || ([self checkKeyPress:n_key_gui_arrow_left]))) {
        ...
        musicModeKeyPressed = NO;

    if ((guiSelectedRow == GUI_ROW(GAME, AUTOSAVE)) &&
        (([self checkKeyPress:n_key_gui_arrow_right]) || ([self checkKeyPress:n_key_gui_arrow_left]))) {
        if ([self checkKeyPress:n_key_gui_arrow_right] != [UNIVERSE autoSave]) [self playChangedOption];
    ...
    if ((guiSelectedRow == GUI_ROW(GAME, GAMMA)) &&
        ...
        if (!gammaControlPressed) {
            ...
            gamma +=
                (((rightKeyDown && (gamma < 4.0f)) ? 0.2f : 0.0f) - ((leftKeyDown && (gamma > 0.2f)) ? 0.2f : 0.0f));
            ...
            [gui setText:[NSString stringWithFormat:@ "%@%@%@ (%.1f) ", gammaWordDesc, v1_string, v0_string, gamma]
    ...
    if ((guiSelectedRow == GUI_ROW(GAME, FOV)) &&
        ...
        if (!fovControlPressed || (script_time > timeLastKeyPress + KEY_REPEAT_INTERVAL)) {
            ...
            fov += (((rightKeyDown && (fov < MAX_FOV_DEG)) ? fovStep : 0.0f) -
                    ((leftKeyDown && (fov > MIN_FOV_DEG)) ? fovStep : 0.0f));
            ...
            [gui setText:[NSString stringWithFormat:@ "%@%@%@ (%d%c) ",
                                                    ...
                                                    v0_string,
                                                    (int)fov,
                                                    176 /*176 is the degrees symbol ASCII code*/]
    ...
    // color blind mode
    if ((guiSelectedRow == GUI_ROW(GAME, COLORBLINDMODE)) &&
        (([self checkKeyPress:n_key_gui_arrow_right]) || ([self checkKeyPress:n_key_gui_arrow_left]))) {
    ...
    if (![gameView hdrOutput]) {
        if ((guiSelectedRow == GUI_ROW(GAME, WIREFRAMEGRAPHICS)) &&
            (([self checkKeyPress:n_key_gui_arrow_right]) || ([self checkKeyPress:n_key_gui_arrow_left]))) {
            if ([self checkKeyPress:n_key_gui_arrow_right] != [UNIVERSE wireframeGraphics]) [self playChangedOption];
        ...
        if ((guiSelectedRow == GUI_ROW(GAME, HDRPAPERWHITE)) &&
            ...
            if (!hdrPaperWhiteControlPressed) {
                ...
                paperWhite += (((rightKeyDown && (paperWhite < MAX_HDR_PAPERWHITE)) ? 10.0f : 0.0f) -
                               ((leftKeyDown && (paperWhite > MIN_HDR_PAPERWHITE)) ? 10.0f : 0.0f));
...
#if !NEW_PLANETS
    if ((guiSelectedRow == GUI_ROW(GAME, PROCEDURALLYTEXTUREDPLANETS)) &&
        (([self checkKeyPress:n_key_gui_arrow_right]) || ([self checkKeyPress:n_key_gui_arrow_left]))) {
    ...
    if (guiSelectedRow == GUI_ROW(GAME, SHADEREFFECTS) &&
        ([self checkKeyPress:n_key_gui_arrow_right] || [self checkKeyPress:n_key_gui_arrow_left])) {
    ...
    if ((guiSelectedRow == GUI_ROW(GAME, DOCKINGCLEARANCE)) &&
        (([self checkKeyPress:n_key_gui_arrow_right]) || ([self checkKeyPress:n_key_gui_arrow_left]))) {
...
- (void)handleKeyMapperScreenKeys {
    ...
    leftRightKeyPressed = [self checkKeyPress:n_key_gui_arrow_right] || [self checkKeyPress:n_key_gui_arrow_left] ||
                          [self checkKeyPress:n_key_gui_page_up] || [self checkKeyPress:n_key_gui_page_down];
    if (leftRightKeyPressed) {
        NSString *key = [gui keyForRow:[gui selectedRow]];
        if ([self checkKeyPress:n_key_gui_arrow_right] || [self checkKeyPress:n_key_gui_page_down]) {
...
- (void)pollCustomViewControls {
    ...
    if ([self checkKeyPress:n_key_custom_view] || joyButtonState[BUTTON_EXTVIEWCYCLE]) {
        if (!customView_pressed && [_customViews count] != 0 && gui_screen != GUI_SCREEN_LONG_RANGE_CHART &&
            ...
            [self switchToThisView:VIEW_CUSTOM
                andProcessWeaponFacing:NO];  // weapon facing must not change, we just want an external view
        }
            ...
            if ([gameView isShiftDown]) {
                ...
                [PLAYER setCustomViewRotationCenter:vector_subtract(viewOffset,
                                                                    vector_multiply_scalar(
                                                                        ...
                                                                        dot_product([PLAYER customViewForwardVector],
                                                                                    viewOffset)))];
            } else {
                quaternion_rotate_about_axis(&newViewQuaternion, axis, -angle);
...
- (void)pollViewControls {
    ...
    if (([self checkKeyPress:n_key_view_forward]) || (virtualView.y < -view_threshold) ||
        joyButtonState[BUTTON_VIEWFORWARD] ||
        ((([self checkKeyPress:n_key_hyperspace] && gui_screen != GUI_SCREEN_LONG_RANGE_CHART) ||
          joyButtonState[BUTTON_HYPERDRIVE]) &&
         [UNIVERSE displayGUI])) {
    ...
    // Zoom scanner 'z'
    if (([self checkKeyPress:n_key_scanner_zoom] && ([gameView allowingStringInput] == gvStringInputNo)) ||
        joyButtonState[BUTTON_SCANNERZOOM])  // look for the 'z' key
    {
        if (!scanner_zoom_rate) {
            if ([hud scannerZoom] < 5.0) {
                if (([hud scannerZoom] > 1.0) || (!zoom_pressed)) scanner_zoom_rate = SCANNER_ZOOM_RATE_UP;
            } else {
    ...
    // Unzoom scanner 'Z'
    if (([self checkKeyPress:n_key_scanner_unzoom] && ([gameView allowingStringInput] == gvStringInputNo)) ||
        joyButtonState[BUTTON_SCANNERUNZOOM])  // look for the 'Z' key
    {
        if ((!scanner_zoom_rate) && ([hud scannerZoom] > 1.0)) scanner_zoom_rate = SCANNER_ZOOM_RATE_DOWN;
    }

    if (EXPECT([[self hud] isCompassActive]))  // only switch compass modes if there is a compass
    {
        // Compass mode '|'
        if ([self checkKeyPress:n_key_prev_compass_mode] ||
            joyButtonState[BUTTON_COMPASSMODE_PREV])  // look for the '|' key
        {
            if ((!prev_compass_mode_pressed) && (compassMode != COMPASS_MODE_BASIC)) [self setPrevCompassMode];
        ...
        {
            if ((!next_compass_mode_pressed) && (compassMode != COMPASS_MODE_BASIC)) [self setNextCompassMode];
    ...
    if ([self checkKeyPress:n_key_cycle_next_mfd] || [self checkKeyPress:n_key_cycle_previous_mfd] ||
        joyButtonState[BUTTON_MFDCYCLENEXT] || joyButtonState[BUTTON_MFDCYCLEPREV]) {
        if (!cycleMFD_pressed) {
            // if (![gameView isCtrlDown])
    ...
    if ([self checkKeyPress:n_key_switch_next_mfd] || [self checkKeyPress:n_key_switch_previous_mfd] ||
        joyButtonState[BUTTON_MFDSELECTNEXT] || joyButtonState[BUTTON_MFDSELECTPREV]) {
...
- (void)pollFlightArrowKeyControls:(double)delta_t {
    ...
    double flightArrowKeyPrecisionFactor =
    ...
    if (!mouse_control_on || (mouse_control_on && mouse_x_axis_map_to_yaw)) {
        if ([self checkNavKeyPress:n_key_roll_left] && [self checkNavKeyPress:n_key_roll_right]) {
            ...
            [self decrease_flight_roll:isCtrlDown ? flightArrowKeyPrecisionFactor * roll_dampner * roll_delta
                                                  : delta_t * roll_delta];
            rolling = YES;
        } else if ([self checkNavKeyPress:n_key_roll_right] && !capsLockCustomView) {
            keyboardRollOverride = YES;
            if (flightRoll < 0.0) flightRoll = 0.0;
            [self increase_flight_roll:isCtrlDown ? flightArrowKeyPrecisionFactor * roll_dampner * roll_delta
                                                  : delta_t * roll_delta];
            rolling = YES;
        }
    }
    if (((mouse_control_on && !mouse_x_axis_map_to_yaw) || numSticks) && !keyboardRollOverride && !capsLockCustomView) {
        ...
        if (flightRoll < stick_roll) {
            ...
            if (flightRoll > stick_roll) flightRoll = stick_roll;
        }
        if (flightRoll > stick_roll) {
    ...
    if (!mouse_control_on) {
        if ([self checkNavKeyPress:n_key_pitch_back] && [self checkNavKeyPress:n_key_pitch_forward]) {
            ...
            [self increase_flight_pitch:isCtrlDown ? flightArrowKeyPrecisionFactor * pitch_dampner * pitch_delta
                                                   : delta_t * pitch_delta];
            pitching = YES;
        } else if ([self checkNavKeyPress:n_key_pitch_forward] && !capsLockCustomView) {
            keyboardPitchOverride = YES;
            if (flightPitch > 0.0) flightPitch = 0.0;
            [self decrease_flight_pitch:isCtrlDown ? flightArrowKeyPrecisionFactor * pitch_dampner * pitch_delta
                                                   : delta_t * pitch_delta];
            pitching = YES;
        }
    }
    if ((mouse_control_on || (numSticks && !keyboardPitchOverride)) && !capsLockCustomView) {
        ...
        if (flightPitch < stick_pitch) {
            ...
            if (flightPitch > stick_pitch) flightPitch = stick_pitch;
        }
        if (flightPitch > stick_pitch) {
    ...
    if (!mouse_control_on || (mouse_control_on && !mouse_x_axis_map_to_yaw)) {
        if ([self checkNavKeyPress:n_key_yaw_left] && [self checkNavKeyPress:n_key_yaw_right]) {
            ...
            [self increase_flight_yaw:isCtrlDown ? flightArrowKeyPrecisionFactor * yaw_dampner * yaw_delta
                                                 : delta_t * yaw_delta];
            yawing = YES;
        } else if ([self checkNavKeyPress:n_key_yaw_right] && !capsLockCustomView) {
            keyboardYawOverride = YES;
            if (flightYaw > 0.0) flightYaw = 0.0;
            [self decrease_flight_yaw:isCtrlDown ? flightArrowKeyPrecisionFactor * yaw_dampner * yaw_delta
                                                 : delta_t * yaw_delta];
            yawing = YES;
        }
    }
    if (((mouse_control_on && mouse_x_axis_map_to_yaw) || numSticks) && !keyboardYawOverride && !capsLockCustomView) {
        ...
        if (flightYaw < stick_yaw) {
            ...
            if (flightYaw > stick_yaw) flightYaw = stick_yaw;
        }
        if (flightYaw > stick_yaw) {
...
- (void)pollGuiScreenControlsWithFKeyAlias:(BOOL)fKeyAlias {
    ...
    if ([self checkKeyPress:n_key_gui_chart_screens fKey_only:!fKeyAlias]) {
        ...
        if (!switching_chart_screens) {
            ...
            if (EXPECT_NOT([self status] == STATUS_WITCHSPACE_COUNTDOWN &&
                           gui_screen == GUI_SCREEN_SHORT_RANGE_CHART)) {
                // don't switch to LRC if countdown in progress
                switching_chart_screens = NO;
            } else if (gui_screen == GUI_SCREEN_SHORT_RANGE_CHART ||
                       (gui_screen == GUI_SCREEN_SYSTEM_DATA && showingLongRangeChart)) {
                ...
                // target_chart_centre = cursor_coordinates = [[UNIVERSE systemManager]
                // getCoordinatesForSystem:target_system_id inGalaxy:galaxy_number];
    ...
    if (docked_okay) {
        if (([self checkKeyPress:n_key_gui_screen_options fKey_only:!fKeyAlias]) &&
...
- (void)pollAutopilotControls:(double)delta_t {
    ...
    if (gui_screen == GUI_SCREEN_KEYBOARD_ENTRY || gui_screen == GUI_SCREEN_KEYBOARD_CONFIG ||
        gui_screen == GUI_SCREEN_KEYBOARD_LAYOUT || gui_screen == GUI_SCREEN_KEYBOARD ||
    ...
    if (![[UNIVERSE gameController] isGamePaused]) {
        ...
        if ([UNIVERSE displayGUI]) [self pollGuiArrowKeyControls:delta_t];
        ...
        if (([self checkKeyPress:n_key_pausebutton] || joyButtonState[BUTTON_PAUSE]) &&
            gui_screen != GUI_SCREEN_SHORT_RANGE_CHART && gui_screen != GUI_SCREEN_MISSION &&
...
- (void)pollDockedControls:(double)delta_t {
    ...
    @try {
        ...
        if (([self checkKeyPress:n_key_pausebutton] || joyButtonState[BUTTON_PAUSE]) &&
            (gui_screen != GUI_SCREEN_LONG_RANGE_CHART && gui_screen != GUI_SCREEN_REPORT &&
        ...
        OOLog(kOOLogException,
              @ "***** Exception in pollDockedControls [%@]: %@ : %@",
              exceptionContext,
              [exception name],
              [exception reason]);
    }
...
- (void)handleUndockControl {
    // FIXME: should this not be in leaveDock:? (Note: leaveDock: is also called from script method launchFromStation
    // and -[StationEntity becomeExplosion]) -- Ahruman 20080308
    [UNIVERSE setUpUniverseFromStation];  // player pre-launch
    if ([self dockedStation] == nil) [self setDockedAtMainStation];

    StationEntity *dockedStation = [self dockedStation];
    if (dockedStation == [UNIVERSE station] && [UNIVERSE autoSaveNow] &&
        ...
        case GUI_SCREEN_INTRO1:
            ...
            if (!selectPressed) {
                if (!disc_operation_in_progress) {
                    if (([gameView isDown:gvMouseDoubleClick] || [self checkKeyPress:n_key_gui_select]) &&
                        [gui selectedRow] == 2 + row_zero) {
                        disc_operation_in_progress = YES;
                        [UNIVERSE removeDemoShips];
                        [gui clearBackground];
                        if (![self loadPlayer]) {
        ...
        case GUI_SCREEN_OXZMANAGER:
            ...
            if (EXPECT(![oxzmanager isRestarting])) {
                if ([oxzmanager isAcceptingGUIInput]) {
                    ...
                    leftRightKeyPressed =
                        [self checkKeyPress:n_key_gui_arrow_right] | [self checkKeyPress:n_key_gui_arrow_left] |
                        [self checkKeyPress:n_key_gui_page_down] | [self checkKeyPress:n_key_gui_page_up];
                ...
                if ([self checkKeyPress:n_key_oxzmanager_setfilter] || [self checkKeyPress:n_key_oxzmanager_showinfo] ||
        ...
        case GUI_SCREEN_MISSION:
            ...
            if (_missionTextEntry) {
                ...
                if ([self checkKeyPress:n_key_gui_select] ||
                    [gameView isDown:gvMouseDoubleClick])  //  '<enter/return>' or double click
                {
                ...
                if ([self checkKeyPress:n_key_gui_select] || [gameView isDown:gvMouseDoubleClick] ||
                    [extraKey length] > 0)  //  '<enter/return>' or double click
                {
                    if ([gameView isDown:gvMouseDoubleClick]) {
                        selectPressed = NO;
                        [gameView clearMouse];
...
- (void)handleMissionCallback {
    ...
    {
        // TODO: This is no longer doing anything because of an 'isDocked' check inside the function. ***** Probably
        // remove it for 1.76
...
- (void)switchToThisView:(OOViewID)viewDirection andProcessWeaponFacing:(BOOL)processWeaponFacing {
    [self switchToThisView:viewDirection
                      fromView:[UNIVERSE viewDirection]
        andProcessWeaponFacing:processWeaponFacing
                    justNotify:NO];
}
...
- (void)switchToThisView:(OOViewID)viewDirection
    ...
    if (processWeaponFacing) {
        ...
        if (facing != WEAPON_FACING_NONE) {
            ...
            OOLogERR(kOOLogParameterError,
                     @ "%s called with processWeaponFacing=YES for non-main view %i.",
                     __FUNCTION__,
                     viewDirection);
        }
    }
    if ((oldViewDirection != viewDirection || viewDirection == VIEW_CUSTOM) &&
        ...
        ShipScriptEvent(context,
                        ...
                        OOJSValueFromViewID(context, oldViewDirection));
...
- (void)handleAutopilotOn:(BOOL)fastDocking {
    ...
    // NSAssert([target isKindOfClass:[StationEntity class]], @"Expected entity with isStation flag set to be a
    // station.");		// no need for asserts. Tested enough already.
    ...
    // Deny if station is hostile or player is a fugitive trying to dock at the main station.
        ...
        [self playAutopilotCannotDockWithTarget];
        message = OOExpandKey(
            (ts == [UNIVERSE station]) ? @ "autopilot-denied" : @ "autopilot-target-docking-instructions-denied",
            stationName);
    }
    // If we're fast-docking, perform the docking logic
        ...
        if (legalStatus > 0) {
            ...
            if ([UNIVERSE inInterstellarSpace])
                government = 2;  // equivalent to Feudal. I'm assuming any station in interstellar space is military. --
                                 // Ahruman 2008-05-29
