...
typedef enum { OPTIMIZED_BY_NONE, OPTIMIZED_BY_JUMPS, OPTIMIZED_BY_TIME } OORouteType;
...
typedef enum { UNITS_TONS, UNITS_KILOGRAMS, UNITS_GRAMS } OOMassUnit;
...
#define VALID_WEAPON_FACINGS \
    (WEAPON_FACING_NONE | WEAPON_FACING_FORWARD | WEAPON_FACING_AFT | WEAPON_FACING_PORT | WEAPON_FACING_STARBOARD)
