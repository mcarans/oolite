...
- (id)initWithPlanetInfo:(NSDictionary *)planetInfo {
    ...
    if ((self = [super initWithPath:[NSString stringWithFormat:@ "OOStandaloneAtmosphereTexture@%p", self]
...
- (NSString *)cacheKey {
    return
        [NSString stringWithFormat:@ "OOStandaloneAtmosphereGenerator-@%u\n%u,%u/%u,%u/%f/%f/%f,%f,%f/%f,%f,%f/%f,%f,%f",
                                   _planetScale,
                                   _info.width,
                                   _info.height,
                                   _info.seed.high,
                                   ...
                                   _info.cloudColor.g,
                                   _info.cloudColor.b,
                                   _info.paleCloudColor.r,
                                   _info.paleCloudColor.g,
                                   _info.paleCloudColor.b];
}
...
END:
    ...
    if (success) {
        NSString *diffuseName =
            [NSString stringWithFormat:@ "atmosphere-%u-%u-diffuse-new", _info.seed.high, _info.seed.low];
        NSString *lightsName =
            [NSString stringWithFormat:@ "atmosphere-%u-%u-alpha-new", _info.seed.high, _info.seed.low];
...
static void AddNoise(OOStandaloneAtmosphereGeneratorInfo *info,
                     float *randomBuffer,
                     float octave,
                     unsigned octaveMask,
                     float scale,
