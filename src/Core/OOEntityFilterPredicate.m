...
BOOL YESPredicate(Entity *entity, void *parameter) { return YES; }

BOOL NOPredicate(Entity *entity, void *parameter) { return NO; }
...
BOOL HasScanClassPredicate(Entity *entity, void *parameter) { return [(id)parameter intValue] == [entity scanClass]; }

BOOL HasClassPredicate(Entity *entity, void *parameter) { return [entity isKindOfClass:(Class)parameter]; }

BOOL IsShipPredicate(Entity *entity, void *parameter) { return [entity isShip] && ![entity isSubEntity]; }

BOOL IsStationPredicate(Entity *entity, void *parameter) { return [entity isStation]; }
...
BOOL IsSunPredicate(Entity *entity, void *parameter) { return [entity isSun]; }

BOOL IsVisualEffectPredicate(Entity *entity, void *parameter) {
    return [entity isVisualEffect] && ![entity isSubEntity];
}

BOOL HasRolePredicate(Entity *ship, void *parameter) { return [(ShipEntity *)ship hasRole:(NSString *)parameter]; }
