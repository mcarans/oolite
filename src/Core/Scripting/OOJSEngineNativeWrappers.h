...
#define OOJS_PROFILE_ENTER OOJS_PROFILE_ENTER_NAMED(__FUNCTION__)
...
struct OOJSProfileStackFrame {
    ...
    const void *key;  // Key to look up profile entries. May be any pointer; currently const char * for native frames
                      // and JSFunction * for JS frames.
